...
export default function BookingPage() {
  ...
  return (
    <div
      className={`min-h-screen w-full flex flex-col items-center justify-center bg-gray-100 px-6 py-10 gap-8 ${sora.variable}`}
    >
      <div
        className="w-full flex flex-col items-center gap-4 mt-30!"
        ...
        {bookingGroups.length > 0 ? (
          bookingGroups.map((group, groupIndex) => (
            <div
              ...
              className="w-8/12 bg-white items-center flex flex-col rounded-lg shadow-lg pt-10 overflow-hidden "
            >
                    ...
                    <div className="border-l-6 border-blue-500 rounded-l-md">
                      <div className="flex flex-row border border-l-0 border-lightblue rounded-l-none rounded-md">
                        ...
                        <div className="mr-6 py-3 text-center ">
                          ...
                          <p className="text-orange-600 font-semibold text-2xl mb-0!">{cat.qtyPerCategory}</p>
                          <p className={`text-gray-400 mb-0! text-xs ${sora.className} tracking-wider`}>Ticket</p>
                        </div>
                      </div>
                    </div>

                    <p className={`text-gray-400 mb-0! text-xs ${sora.className} my-2 tracking-wider`}>TICKET</p>
          ...
          <div className="w-8/12 bg-white flex flex-col rounded-lg shadow-lg overflow-hidden">
            <div className="bg-blue-950 w-full h-10 flex flex-row items-center gap-4 px-6">
              <BarcodeOutlined className="text-2xl text-white!" />
              <p className="text-xl font-medium uppercase tracking-wider text-white mb-0!">My Bookings</p>
            </div>
            ...
            <div className="py-20 w-full flex flex-col items-center justify-center text-center">
              ...
              <p className="text-gray-500 text-sm mt-2">You haven't purchased any tickets yet. Your booking history will appear here.</p>
              <button
